...
int main(void) {
    ...
    Image *lenaImg = imgReadPPM("C:/Users/Daniel/Downloads/Computacao_Grafica/18.Mascara.Linha.DiagonalDE/lena-std.pnm");
    ...
    imgWritePPM(lenaImgGray, "C:/Users/Daniel/Downloads/Computacao_Grafica/18.Mascara.Linha.DiagonalDE/Resultado/foto256Bin.ppm");
