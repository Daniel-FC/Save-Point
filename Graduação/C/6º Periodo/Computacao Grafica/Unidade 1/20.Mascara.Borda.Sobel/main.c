...
int main(void) {
    ...
    Image *lenaImg = imgReadPPM("C:/Users/Daniel/Downloads/Computacao_Grafica/20.Mascara.Borda.Sobel/lena-std.pnm");
    ...
    imgWritePPM(lenaImgGray, "C:/Users/Daniel/Downloads/Computacao_Grafica/20.Mascara.Borda.Sobel/Resultado/foto256Bin.ppm");
