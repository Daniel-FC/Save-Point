...
int main(void) {
    ...
    Image *lenaImg = imgReadPPM("C:/Users/Daniel/Downloads/Computacao_Grafica/3.Contraste.Interno/lena-std.pnm");
    ...
    imgWritePPM(lenaImgGray, "C:/Users/Daniel/Downloads/Computacao_Grafica/3.Contraste.Interno/Resultado/foto256Bin.ppm");
