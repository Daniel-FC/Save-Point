...
int main(void) {
    ...
    Image *lenaImg = imgReadPPM("C:/Users/Daniel/Downloads/Computacao_Grafica/21.Mascara.Borda. Prewit/lena-std.pnm");
    ...
    imgWritePPM(lenaImgGray, "C:/Users/Daniel/Downloads/Computacao_Grafica/21.Mascara.Borda. Prewit/Resultado/foto256Bin.ppm");
