...
int main(void) {
    ...
    Image *lenaImg = imgReadPPM("C:/Users/Daniel/Downloads/Computacao_Grafica/1.Binarizacao/lena-std.pnm");
    ...
    imgWritePPM(lenaImgGray, "C:/Users/Daniel/Downloads/Computacao_Grafica/1.Binarizacao/Resultado/foto256Bin.ppm");
