...
int main(void) {
    ...
    Image *lenaImg = imgReadPPM("C:/Users/Daniel/Downloads/Computacao_Grafica/4.Contraste.Externo/lena-std.pnm");
    ...
    imgWritePPM(lenaImgGray, "C:/Users/Daniel/Downloads/Computacao_Grafica/4.Contraste.Externo/Resultado/foto256Bin.ppm");
